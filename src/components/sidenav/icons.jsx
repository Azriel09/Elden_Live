...
import OkayuPic from "../../assets/talent-icons/okayu.png";
import FlarePic from "../../assets/talent-icons/flare.png";
import LuiPic from "../../assets/talent-icons/lui.png";
import LunaPic from "../../assets/talent-icons/luna.png";
import MikoPic from "../../assets/talent-icons/miko.png";
import ChloePic from "../../assets/talent-icons/chloe.png";
import KoyoriPic from "../../assets/talent-icons/koyori.png";
import LamyPic from "../../assets/talent-icons/lamy.png";
import BotanPic from "../../assets/talent-icons/botan.png";
import PekoraPic from "../../assets/talent-icons/pekora.png";
import NoelPic from "../../assets/talent-icons/noel.png";
...
export function CalliIcon() {
  return <img src={CalliPic} style={{ borderRadius: "50%", width: "35px" }} />;
}

export function InaIcon() {
  return <img src={InaPic} style={{ borderRadius: "50%", width: "35px" }} />;
}

export function IrysIcon() {
  return <img src={IrysPic} style={{ borderRadius: "50%", width: "35px" }} />;
}

export function KroniiIcon() {
  return <img src={KroniiPic} style={{ borderRadius: "50%", width: "35px" }} />;
}
